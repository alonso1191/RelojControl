<%-- 
    Document   : login
    Created on : 08-05-2017, 14:26:15
    Author     : Alonso
--%>
...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <title>Login</title>
        <meta name="description" content="Sistema Gestion Hraria Docente">
        <!-- end: Meta -->
                        ...
                        <form class="form-horizontal" action="LoginServlet" method="post">
                            <fieldset>
                                ...
                                <div class="mensaje" id="mensaje">
                                    ...
                                    <strong><% if (mensaje !=null &&  mensaje !="")out.print(mensaje); %></strong>
                                </div>
                                <div class="clearfix"></div>
                            </fieldset>
                        </form>
